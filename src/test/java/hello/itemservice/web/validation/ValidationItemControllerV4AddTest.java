...
public class ValidationItemControllerV4AddTest {
    private MockMvc mvc;
    ...
    void addItemTest() throws Exception {
        //given
        //when
        ResultActions perform = mvc.perform(post("/validation/v4/items/add")
        ...
        perform.andDo(print())
                ...
                .andExpect(result -> {
                    ...
                    redirectedUrl(MessageFormat.format("/validation/v4/items/{0}?status=true", itemId));
                })
//                .andExpect(redirectedUrl("/validation/v4/items/1?status=true"))
        ;
    }
    ...
    void addItemFieldBlankErrorTest() throws Exception {
        //when-then blank
        mvc.perform(post("/validation/v4/items/add")
                        .param("price", "1000").param("quantity", "100")//valid
                        .param("itemName", " ")
                ).andDo(print())
                .andExpect(status().isOk())
                .andExpect(view().name("validation/v4/addForm"))
